...
server-configurator - A complete turn-key solution for configuring a fresh installation of Ubuntu 18.04 Server

HISTORY

	As a casual user of Ubuntu Server for many years, it has often been a
	...
	become outdated, the Ubuntu Server Configurator was created instead. It is
	specifically designed to bring a fresh installation of Ubuntu 18.04 Server
	up and running at its full potential given the hardware environment of the
	end user.

	Well over a thousand hours have been put into making the Ubuntu Server
	...
	The ultimate goal is for end users to enjoy their Ubuntu Server experience
	...
	Ubuntu Server for (website, database, etc).
...
CONTACT INFORMATION
	...
	GitHub Project Page   : https://github.com/devopsbroker/server-configurator
